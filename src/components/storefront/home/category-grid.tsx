...
export function CategoryGrid({ categories }: { categories: Tables<"categories">[] }) {
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
      <h2 className="mb-4 flex items-center gap-2.5 text-lg font-semibold text-foreground sm:text-xl">
      ...
      <div className="grid grid-cols-3 gap-3 sm:grid-cols-4 lg:grid-cols-6">
        {categories.map((c) => (
          ...
          >
            <div className="relative flex size-14 items-center justify-center overflow-hidden rounded-full bg-gradient-to-br from-primary-50 to-accent-50 transition-transform duration-300 group-hover:scale-105 sm:size-16">
              {c.image_url ? (
